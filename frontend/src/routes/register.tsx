            ...
            <div className="hidden lg:flex flex-col relative bg-zinc-950 text-white p-10 dark:border-r overflow-hidden">
                ...
                <div className="relative z-20 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-lg">
                            &ldquo;We needed a way to bridge our legacy Google Forms to our new CRM. GAS Bridge Hub made it effortless.&rdquo;
                        </p>
                        <footer className="text-sm text-gray-400">Rival, Product Manager</footer>
                    </blockquote>
                </div>
            </div>
